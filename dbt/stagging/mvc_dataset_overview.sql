...
WITH 
T_C AS (SELECT collision_id, date_part('year', crash_date) AS "year", borough, vhc_1_code, contr_f_vhc_1 FROM "magic".mvc_c_2020 UNION ALL 
	   SELECT collision_id, date_part('year', crash_date) AS "year", borough, vhc_1_code, contr_f_vhc_1 FROM "magic".mvc_c_2021 UNION ALL
	   SELECT collision_id, date_part('year', crash_date) AS "year", borough, vhc_1_code, contr_f_vhc_1 FROM "magic".mvc_c_2022 ),
T_V AS (SELECT collision_id, date_part('year', crash_date) AS "year", vhc_type, vhc_year, dr_lic_status FROM "magic".mvc_v_2020 UNION ALL
		SELECT collision_id, date_part('year', crash_date) AS "year", vhc_type, vhc_year, dr_lic_status FROM "magic".mvc_v_2021 UNION ALL
		SELECT collision_id, date_part('year', crash_date) AS "year", vhc_type, vhc_year, dr_lic_status FROM "magic".mvc_v_2022 ),
T_P AS (SELECT collision_id, date_part('year', crash_date) AS "year", age, sex FROM "magic".mvc_p_2020 UNION ALL
	   SELECT collision_id, date_part('year', crash_date) AS "year", age, sex FROM "magic".mvc_p_2021 UNION ALL
	   SELECT collision_id, date_part('year', crash_date) AS "year", age, sex FROM "magic".mvc_p_2022 ),
